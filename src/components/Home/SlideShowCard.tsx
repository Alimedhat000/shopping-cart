...
import ModelDetailImage from '../../assets/model-banner-2-closeup.png'; // Adjust path as needed
...
export const SecondSlideShowCard = () => {
  return (
    <div className="relative mx-auto flex min-h-[600px] w-full max-w-7xl overflow-hidden rounded-3xl bg-[#f2ebd9]">
      ...
      {/* Bottom Section */}
      <div className="absolute right-0 bottom-0 left-0 h-1/2 bg-black text-white">
